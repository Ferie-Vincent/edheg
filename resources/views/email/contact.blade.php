                        ...
                        <tbody>
                            <tr>
                                <td class="header"
                                    ...
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Coat_of_Arms_of_the_Ivory_Coast.svg/langfr-400px-Coat_of_Arms_of_the_Ivory_Coast.svg.png"
                                        class="logo" alt="Logo"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 20px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                        Ce message a été envoyé par {{ $data['name'] }} .</p>

                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 20px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                        <span style="margin: 20px !important">
                                                            <strong>Réquérant:</strong> {{ $data['name'] }}<br>
                                                        </span>

                                                        <hr style="width: 50%; margin: 20px; !important">
                                                        ...
                                                        <span style="margin: 20px !important">
                                                            <strong>Sujet:</strong> {{ $data['msg_subject'] }}<br>
                                                        </span>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="content-cell" align="center"
                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; padding: 32px;">
                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 12px; line-height: 1.5em; margin-top: 0; text-align: center;">
                                                        © {{ date('Y') }} GPE-EDHEG. Tous droits réservés.</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
