...
@section('title', 'Tertiaires')

@section('content')

    <!-- Start Page Title Area -->
    <div class="page-title-area-ter bg-20">
        <div class="container">
            <div class="page-title-content text-white">
                <h2 class="text-white">Filières Tertiaires</h2>
                ...
                <ul>
                    ...
                    <li class="active text-white">Filières Tertiaires</li>
                </ul>
            </div>
        </div>
    </div>
